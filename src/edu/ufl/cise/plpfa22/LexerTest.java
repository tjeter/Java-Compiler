...
class LexerTest {
	...
	void checkText(IToken t, String expectedText) {
		assertEquals(expectedText, String.valueOf(t.getText()));
	}
 ...
 // The lexer should add an EOF token to the end.
 	@Test
 	void testEmpty2() throws LexicalException {
 		String input = "";
 		show(input);
 		ILexer lexer = getLexer(input);
 		show(lexer);
 	...
 	// A couple of single character tokens
 	@Test
 	void testSingleChar02() throws LexicalException {
 		String input = """
 				+
 				-
 				""";
 	...
 	// comments should be skipped
 	@Test
 	void testComment02() throws LexicalException {
 		// Note that the quotes around "This is a string" are passed to the lexer.
 		String input = """
 				"This is a string"
 				// this is a comment
 	...
 	// Example for testing input with an illegal character
 	@Test
 	void testError02() throws LexicalException {
 		String input = """
 				abc
 				@
 				""";
 	...
 	// Several identifiers to test positions
 	@Test
 	public void testIdent02() throws LexicalException {
 	...
 	// Example showing how to handle number that are too big.
 	@Test
 	public void testIntTooBig2() throws LexicalException {
 		String input = """
 				42
 				99999999999999999999999999999999999999999999999999999999999999999999999
 				""";
 	...
 	@Test
 	public void testEscapeSequences02() throws LexicalException {
 		String input = "\"\\b \\t \\n \\f \\r \"";
 		show(input);
 		ILexer lexer = getLexer(input);
 		IToken t = lexer.next();
 	...
 	@Test
 	public void testEscapeSequences12() throws LexicalException {
 		String input = "   \" ...  \\\"  \\\'  \\\\  \"";
 		show(input);
 		ILexer lexer = getLexer(input);
 		IToken t = lexer.next();
 	...
 	public void testGetStringValue1() throws LexicalException {
 		...
 		show(input);
 		ILexer lexer = getLexer(input);
 		checkString(lexer.next(), "\"word\\b\"", "word\b", 1, 1);
 	}
 	...
 	// Mix of ID's, Num_lit, comments, string_lit's
 	@Test
 	public void testIDNNUM2() throws LexicalException {
 		String input = """
 				df123 345 g546 IF
 				//next is string
 	...
 	@Test
 	public void testInvalidIdent2() throws LexicalException {
 		String input = """
 				$valid_123
 				valid_and_symbol+
 				invalid^
 	...
 	@Test
 	public void testNonEndString() throws LexicalException {
 		String input = """
 				"yo yo yo yo yo
 				""";
 		show(input);
 	...
 	@Test
 	public void testNonEndComment() throws LexicalException {
 		String input = """
 				//yo yo yo yo yo
 				""";
 		show(input);
 	...
 	@Test
 	public void testEOFs() throws LexicalException {
 		String input = """
 				//yo yo yo yo yo
 				""";
 		show(input);
